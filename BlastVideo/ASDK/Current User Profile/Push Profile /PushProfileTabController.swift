//
//  PushProfileTabController.swift
//  BlastVideo
//
...
class PushProfileTabController: ButtonBarPagerTabStripViewController, PagerAwareProtocol {
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let vc1 = PushProfileFavs(user: user ?? UserObject())
        vc1.pageTitle = "Favorites"
        let child_1 = vc1
        
        let vc2 = PushProfilePosts(user: user ?? UserObject())
        vc2.pageTitle = "Posts"
        let child_3 = vc2
